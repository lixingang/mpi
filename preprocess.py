...
# [31:  223, 31:  223]
# [15:  239,15:  239]
def tf2pth(source_dir="Data/raw_data", target_dir="Data/origin192"):
...
def tf2pth_reduce(source_dir="Data/raw_data", target_dir="Data/input_data2"):
    ...
    for f in tqdm(os.listdir(source_dir)):
        ...
        for key in content.keys():
            ...
            if key in args["D"]["label_keys"]:
                res[key] = content[key]
            # if key in args["D"]["indicator_keys"]:
            #     res[key] = content[key]
            ...
            #         res[key],
            #         bins=20,
            #         range=(NORM_MIN[key], NORM_MAX[key]),
            #         density=True,
            #     )
            ...
            # if key not in not_norm_list:
            #     res[key] = (res[key] - NORM_MIN[key]) / (
            #         NORM_MAX[key] - NORM_MIN[key]
            #     )
...
def get_norm_parameters(pth_dir="pth"):
    NORM_MIN = {}
    NORM_MAX = {}
